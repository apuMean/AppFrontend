...
class EstimateConfig extends React.Component {
	...
	render() {
		...
		const items = this.props.itemColumns.map((val, i) => (
			<div key={i} className="input-group list-sort-item" style={{ marginBottom: '8px', width: '200px', display: val.isHidden ? 'none' : '' }}>
				<span className="input-group-addon">
					<input type="checkbox" checked={val.isVisible} onChange={this.props.handleVisibleToggle.bind(self, i, 'HEADER')} />
				</span>
				<input type="text"
		...
		const totals = this.props.totalColumns.map((val, i) => (
			<div key={i} className="input-group list-total-sort" style={{ marginBottom: '8px', width: '200px' }}>
				<span className="input-group-addon">
					<input type="checkbox" checked={val.isVisible} onChange={this.props.handleVisibleToggle.bind(self, i, 'TOTAL')} />
				</span>
				<input type="text"
		...
		return (
			<div className="col-lg-3 col-md-3 col-sm-3 col-xs-12" ref="est_config">
								...
								<div className="row">
									...
									<div className="col-md-12">
										<div className="input-group" style={{ marginBottom: '8px', width: '200px' }}>
											...
											<textarea className="form-control" rows="2" style={{ resize: 'none' }} disabled={true} defaultValue="Show dollar signs in item rows" />
										</div>
									</div>
									<div className="col-md-12">
										<div className="input-group" style={{ marginBottom: '8px', width: '200px' }}>
									...
									<div className="col-md-12">
										<div className="input-group" style={{ marginBottom: '8px', width: '200px'}}>
											<span className="input-group-addon">
												<input type="checkbox" defaultChecked={this.props.includeEstimateName} key={this.props.includeEstimateName} onChange={this.props.handleMergeName} />
											</span>
											<textarea className="form-control" rows="2" style={{ resize: 'none'}} disabled={true} defaultValue="Include Estimate Name" />
										</div>
									</div>
								</div>
							</form>
