                                ...
                                <form role="form" id="createExpense">
                                    <div className="form-body">
                                        <div className="row">
                                            ...
                                            <div className="col-md-6">
                                                <div className="form-group form-md-line-input form-md-floating-label">
                                                    <TextareaAutosize style={{ resize: 'none' }} className="form-control" rows={1} ref="description"></TextareaAutosize>
                                            ...
                                            <div className="col-md-6">
                                                <div className="form-group form-md-line-input form-md-floating-label">
                                                    <TextareaAutosize style={{ resize: 'none' }} className="form-control" rows={1} ref="notes"></TextareaAutosize>
