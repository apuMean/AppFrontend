...
class InvoiceAdd extends React.Component {
    ...
    componentDidMount() {
        ...
        if (localStorage.projectInvoiceId && localStorage.invoiceProjectName) {
            var obj = {
                id: localStorage.projectInvoiceId,
                label: localStorage.invoiceProjectName
            }
            this.setState({ projectValue: obj })
        }

        if (localStorage.contactInvoiceId) {

            var contact = {
                contactId: localStorage.contactInvoiceId
            }
            this
                .props
                .contactactions
    ...
    componentWillUnmount() {
        localStorage.setItem("projectInvoiceId", '');
        localStorage.setItem("invoiceProjectName", '');
        localStorage.setItem("contactInvoiceId", '');
    }
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (localStorage.contactInvoiceId && company.length == 0 && individual.length == 0) {
            var companyVal = {
        ...
        this.setState({
            ...
            poOptions: poNumbers, individualOptions: individual
        })
        setTimeout(function () {
            layout
                .FloatLabel
            ...
            <div>
                <div className="portlet-title tabbable-line">
                    <ul className="nav nav-tabs">
                        <li className="active">
                            <a href="#invoice-add" data-toggle="tab">
                                Invoice
                            </a>
                        </li>
                        {/*<li>
                            <a href="#invoice-payments" data-toggle="tab">
                                Payments
                            </a>
                        </li>
                        <li>
                            <a href="#invoice-moreinfo" data-toggle="tab">
                                More Info
                            </a>
                        </li>*/}
                        <div className="form-actions noborder text-right">
                            {localStorage.contactInvoiceId ? <Link to={localStorage.contactInvoiceId ? "/contactinvoices/" + localStorage.contactInvoiceId : "/invoice"} className="btn red">
                                Cancel
                            </Link> : <Link to={localStorage.projectInvoiceId ? "/project_invoices/" + localStorage.projectInvoiceId : "/invoice"} className="btn red">
                                    Cancel
                            </Link>}
                            &nbsp;&nbsp;<button type="button" className="btn blue" onClick={this.invoiceHandler}>Save</button>
                        </div>
                    </ul>
                </div>
                            ...
                            <div className="tab-pane active" id="invoice-add">
                                ...
                                <form role="form" id="createInvoice">
                                    <div className="form-body">
                                        <div className="row">
                                            ...
                                            <div className="col-md-6">
                                                <div className="form-group form-md-line-input form-md-floating-label">
                                                    <select className="form-control edited" name="terms" ref="terms">
                                            ...
                                            <div className="col-md-6">
                                                <div className="form-group form-md-line-input form-md-floating-label">
                                                    <select className="form-control edited" name="class" ref="class">
                                                        <option value="0">Select</option>
                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="col-md-12">
                                            <div className="form-group form-md-line-input form-md-floating-label">
                                                <select className="form-control edited" name="customerMessage" ref="customerMessage">
                                                    <option value="0">Select</option>
                                        ...
                                        <div className="col-md-12">
                                            <div className="form-group form-md-line-input form-md-floating-label">
                                                <textarea type="text" className="form-control" rows="1" ref="memo" defaultValue="" ></textarea>
                                    ...
                                    <div className="tab-content">
                                        <form action="#" className="horizontal-form">
                                            <div className="form-body">
                                                <div className="row">
                                                    ...
                                                    <div className="col-md-4">
                                                        <div className="form-group form-md-line-input form-md-floating-label">
                                                            ...
                                                            <label htmlFor="form_control_1">List ID</label>
                                                        </div>
                                                    </div>
                                                    <div className="col-md-4">
                                                        <div className="form-group form-md-line-input form-md-floating-label">
                                                            ...
                                                            <label htmlFor="form_control_1">QB Inv #</label>
                                                        </div>
                                                    </div>
                                                    <div className="col-md-4">
                                                        <div className="form-group form-md-line-input form-md-floating-label">
                                                            <label className="rememberme mt-checkbox mt-checkbox-outline">
                                                                <input type="checkbox" name="remember" value="1"/>Refresh
                                                                <span></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div className="col-md-4">
                                                        <div className="form-group form-md-line-input form-md-floating-label">
                                                            <input type="text" className="form-control" id="" defaultValue=""/>
                                                ...
                                                <div className="form-actions noborder text-right">
                                                    <button type="button" className="btn blue">Save</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
