export const ComponentsDropdowns = function () {
    ...
    var handleMultiSelectForGroup = function () {
        jQuery("#my_multi_select1").multiSelect('refresh');
        jQuery('#my_multi_select1').multiSelect();
    }

    var handleMultiSelectForUser = function () {
       jQuery("#my_multi_select2").multiSelect('refresh');
    ...
    return {
        ...
        init: function () {
            // handleSelect2();
            // handleSelect2Modal();
            handleMultiSelectForGroup();
            handleMultiSelectForUser();
