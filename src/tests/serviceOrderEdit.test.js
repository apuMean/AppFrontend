...
describe('Update Serice Order Controlled component', () => {
    it('Should have active tab with text service order', function (done) {
        const wrapper = mount(<Provider store={store}><EditOrder {...props} /></Provider>);
    ...
    it('Service order save button should be of type button', (done) => {
        const wrapper = mount(<Provider store={store}><EditOrder {...props} /></Provider>);
