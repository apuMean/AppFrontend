...
describe('Update Opportunity Controlled component', () => {
    it('Should have active tab with text Opportunity', function (done) {
        const wrapper = mount(<Provider store={store}><OpportunityEdit {...props} /></Provider>);
    ...
    it('Opportunity update button should be of type button', (done) => {
        const wrapper = mount(<Provider store={store}><OpportunityEdit {...props} /></Provider>);
